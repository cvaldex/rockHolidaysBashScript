...
psql -h $DB_HOST -U $DB_USER -d $DB_DBNAME -v a_date=\'$TODAY_DATE\' --file ../sql/insert_today_tweets.sql >> $LOG_FILE 2>&1

cat $LOG_FILE | mail -s "Movimiento de registros a tabla diaria $CURRENT_DATE" todayinrockhistorytwitter@gmail.com
